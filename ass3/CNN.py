...
class CNN:
	...
	def data_pre_processing(self):
		"""Performs normalization on input sets to speed up learning."""
		# Perform pixel-wise normalization
	...
	def change_data_shape(self):
		"""One hot encodes the target sets. Reshapes the input sets."""
		# One hot encoding
	...
	def split_dataset(self):
		...
		# We want to use a validation set to validate our model, and keep the test set for training purposes only.
	...
	def model_analysis(self, loss_bool=False, acc_bool=True, comp_bool=True, history=None):
		"""Analysis of the model. Plotting accuracy, loss, confusion matrix and f1 score."""
		# Loss history
		if history is None:
	...
	def setup(self, visualize_bool=False, statistics_bool=False, class_distribution_bool=False):
		"""Perform operations on the datasets to prepare for training."""
